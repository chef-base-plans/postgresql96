title 'Tests to confirm postgresql96 habitat service works as expected'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'postgresql96')

control 'core-plans-postgresql96-habservice-works' do
  impact 1.0
  title 'Ensure postgresql96 habitat service works as expected'
  desc '
  Verify postgresql96 habitat service by ensuring that
